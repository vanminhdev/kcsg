 ...
 */
package org.opendaylight.sina.cli.commands;
...
public class SinaCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(SinaCliTestCommand.class);
    protected final SinaCliCommands service;

    public SinaCliTestCommand(final SinaCliCommands service) {
